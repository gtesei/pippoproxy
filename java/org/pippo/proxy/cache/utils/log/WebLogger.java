...
public abstract class WebLogger extends MyLogger {
	
	public static void initDefaultLogger(ServletConfig config,String name)
		throws Exception {
		
		String appHome = config.getServletContext().getRealPath("/");
		String logDir = appHome+File.separator+"logs";
		
		System.out.println("logDir:"+logDir);
		
		initDefaultLogger(name,logDir);
	}
